...
export default {
	...
	methods: {
		beforeLeave(el) {
			this.$refs.transition.beforeLeave &&
				this.$refs.transition.beforeLeave(el);
		},
		leave(el, done) {
		...
		afterLeave(el) {
			this.$refs.transition.afterLeave &&
				this.$refs.transition.afterLeave(el);
		},
		beforeEnter(el) {
		...
		afterEnter(el) {
			this.$refs.transition.afterEnter &&
